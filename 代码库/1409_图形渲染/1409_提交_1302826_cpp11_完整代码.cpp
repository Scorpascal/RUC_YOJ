...
public:
   Sphere(string n, double r) : Shape(n, true), radius(r) {}
   double getArea() const override
   {
      return 4 * 3.14159 * radius * radius; // π使用3.14159
   } // 初始化
                                double getVolume() const override
   {
      return (4.0 / 3.0) * 3.14159 * radius * radius * radius; // π使用3.14159
   } // π使用3.14159
                                ~Sphere()
   {
...
public:
   Rectangle(string n, double w, double h) : Shape(n, false), width(w), height(h) {} // 初始化基类和成员变量
                                             double getArea() const override
   {
